                                        ...
                                        <form class="form" action="{{route('update.shipping.methods', $shippingMethod -> id)}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/edition.method name')}} </label>
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1"
                                                    ...
                                                    <i class="ft-x"></i> {{__('admin/edition.move back')}}
                                                </button>
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i>{{__('admin/edition.save')}}
                                                </button>
                                            </div>
                                        </form>
                                    </div>
